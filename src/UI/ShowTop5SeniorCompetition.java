    ...
    public void getOptions(){
        ...
        switch (userInputDiscipline) {
            case 1 -> {
                ...
                readResults.getTop5("resources/eliteResults/seniorResults/competition/butterfly.csv");
            }
            case 2 -> {
                System.out.println("Top 5 Breaststroke:");
                readResults.getTop5("resources/eliteResults/seniorResults/competition/breastStroke.csv");
            }
            case 3 -> {
                System.out.println("Top 5 Crawl:");
                readResults.getTop5("resources/eliteResults/seniorResults/competition/crawl.csv");
            }
            case 4 -> {
                System.out.println("Top 5 Backcrawl:");
                readResults.getTop5("resources/eliteResults/seniorResults/competition/backcrawl.csv");
            }
        }
    }
    }
