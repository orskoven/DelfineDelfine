    ...
    public void getOptions(){
        ...
        switch (userInputDiscipline) {
            ...
            case 2 -> {
                ...
                readResults.getTop5("resources/eliteResults/juniorResults/competition/breastStroke.csv");
            }
            case 3 -> {
                System.out.println("Top 5 Crawl:");
                readResults.getTop5("resources/eliteResults/juniorResults/competition/crawl.csv");
            }
            case 4 -> {
